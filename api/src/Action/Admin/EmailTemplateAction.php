...
final class EmailTemplateAction
{
     ...
     */
    private const KNOWN = ['invoice_send', 'invoice_payment_thanks', 'invoice_reminder', 'proforma_reminder', 'recurring_draft_reminder', 'password_reset', 'login_otp', 'email_profile_test'];
