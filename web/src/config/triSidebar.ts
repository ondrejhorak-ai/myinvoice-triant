...
export const TRI_SIDEBAR_MODULES = [
  ...
  { id: 'documents', labelKey: 'nav.documents', hideable: true },
  ...
  { id: 'tax-optimizer', labelKey: 'nav.tax_optimizer', hideable: true },
  ...
  { id: 'bank-accounts', labelKey: 'nav.bank_accounts', hideable: true },
